...
$(document).ready(function() {
	...
	$("#payment-form").submit(function(event) {
		...
		// 
		// Get the values:
		var ccNum = $('.card-number').val(), cvcNum = $('.card-cvc').val(), expMonth = $('.card-expiry-month').val(), expYear = $('.card-expiry-year').val(), addressZip = $('.card-addresszip').val(), CCname = $('.card-nameOnCard').val();
